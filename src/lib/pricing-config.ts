...
export const ENVELOPE_SIZES: Record<EnvelopeSizeKey, string> = {
    'four_bar': '4-Bar Envelope (3.625 x 5.125 in)',
    'a2': 'A2 Envelope (4.375 x 5.75 in)',
    'a6': 'A6 Envelope (4.75 x 6.5 in)',
    'a7': 'A7 Envelope (5.25 x 7.25 in)',
    'a9': 'A9 Envelope (5.75 x 8.75 in)',
    'square_5_25': '5.25" Square Envelope',
};
